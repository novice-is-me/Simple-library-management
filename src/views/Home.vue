            ...
            <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
                <div class="max-w-2xl text-center mx-auto">
                    ...
                    <div class="mt-5 max-w-3xl">
                        <p class="text-lg text-gray-600">A Library Management System (LMS) is a software application designed to help manage and organize the day-to-day operations of a library</p>
                    </div>
                    
                    <!-- Buttons -->
                    <div class="mt-8 gap-3 flex justify-center">
                        <router-link class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" :to="'/books'">
                            Get started
